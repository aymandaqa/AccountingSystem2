...
namespace AccountingSystem.Migrations
{
    ...
    partial class AddAccountSettlements : Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountingSystem.Models.AccountSettlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingSystem.Models.AccountSettlementPair", b =>
                {
                    ...
                    b.Property<int>("AccountSettlementId")
                        .HasColumnType("int");

                    b.Property<int>("CreditLineId")
                        .HasColumnType("int");

                    b.Property<int>("DebitLineId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("AccountSettlementId");

                    b.HasIndex("CreditLineId");

                    b.HasIndex("DebitLineId");

                    b.ToTable("AccountSettlementPairs");
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Asset", b =>
                {
                    ...
                    b.Property<bool>("AllowAssetExpenses")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.Property<int?>("DepreciationFrequency")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingSystem.Models.AssetDepreciation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Counter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingSystem.Models.EmployeeLoan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingSystem.Models.EmployeeLoanInstallment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmployeeLoanInstallments");
                });

            modelBuilder.Entity("AccountingSystem.Models.EmployeeLoanPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmployeeLoanPayments");
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.PayrollBatchLineDeduction", b =>
                {
                    ...
                    b.Property<int?>("EmployeeLoanInstallmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmployeeLoanInstallmentId");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Category = "الموردين",
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            DisplayName = "عرض أنواع الموردين",
                            IsActive = true,
                            Name = "suppliertypes.view"
                        },
                        new
                        {
                            Id = 116,
                            Category = "الموردين",
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            DisplayName = "إنشاء نوع مورد",
                            IsActive = true,
                            Name = "suppliertypes.create"
                        },
                        new
                        {
                            Id = 117,
                            Category = "الموردين",
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            DisplayName = "تعديل نوع مورد",
                            IsActive = true,
                            Name = "suppliertypes.edit"
                        },
                        new
                        {
                            Id = 44,
            ...
            modelBuilder.Entity("AccountingSystem.Models.Reports.CashPerformanceRecord", b =>
                {
                    ...
                    b.Property<decimal>("CashOnBranchBox")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CashWithDriverOnRoad")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CustomerDues")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CustomerDuesOnRoad")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.ToTable("ViewCashPerformance");

                    b.ToView("ViewCashPerformance", (string)null);
                });
            ...
            modelBuilder.Entity("AccountingSystem.Models.Supplier", b =>
                {
                    ...
                    b.Property<bool>("ShowAccountStatement")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AccountingSystem.Models.SupplierType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingSystem.Models.AccountSettlementPair", b =>
                {
                    b.HasOne("AccountingSystem.Models.JournalEntryLine", "CreditLine")
                        .WithMany()
                        .HasForeignKey("CreditLineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AccountingSystem.Models.JournalEntryLine", "DebitLine")
                        .WithMany()
                        .HasForeignKey("DebitLineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AccountingSystem.Models.AccountSettlement", "Settlement")
                        .WithMany("Pairs")
                        .HasForeignKey("AccountSettlementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CreditLine");

                    b.Navigation("DebitLine");
            ...
            modelBuilder.Entity("AccountingSystem.Models.AssetType", b =>
                {
                    ...
                    b.HasOne("AccountingSystem.Models.Account", "AccumulatedDepreciationAccount")
                        .WithMany()
                        .HasForeignKey("AccumulatedDepreciationAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AccountingSystem.Models.Account", "DepreciationExpenseAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("AccountingSystem.Models.EmployeeLoanInstallment", b =>
                {
                    b.HasOne("AccountingSystem.Models.EmployeeLoan", "Loan")
                        .WithMany("Installments")
                        .HasForeignKey("EmployeeLoanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AccountingSystem.Models.PayrollBatchLine", "PayrollBatchLine")
                        .WithMany()
            ...
            modelBuilder.Entity("AccountingSystem.Models.PayrollBatchLineDeduction", b =>
                {
                    ...
                    b.HasOne("AccountingSystem.Models.EmployeeLoanInstallment", "EmployeeLoanInstallment")
                        .WithMany()
                        .HasForeignKey("EmployeeLoanInstallmentId");
                    ...
                    b.Navigation("EmployeeLoanInstallment");
            ...
            modelBuilder.Entity("AccountingSystem.Models.Supplier", b =>
                {
                    ...
                    b.HasOne("AccountingSystem.Models.SupplierType", "SupplierType")
                        .WithMany("Suppliers")
            ...
            modelBuilder.Entity("AccountingSystem.Models.Workflows.WorkflowStep", b =>
                {
                    ...
                    b.HasOne("AccountingSystem.Models.Workflows.WorkflowStep", "ParentStep")
                        .WithMany("ChildSteps")
