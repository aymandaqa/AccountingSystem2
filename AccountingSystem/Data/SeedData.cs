    ...
    public static class SeedData
    {
        ...
        private static async Task SeedPermissionsAsync(ApplicationDbContext context)
        {
            var permissions = new List<Permission>
            {
                ...
                new Permission { Name = "suppliertypes.view", DisplayName = "عرض أنواع الموردين", Category = "الموردين" },
                new Permission { Name = "suppliertypes.create", DisplayName = "إنشاء نوع مورد", Category = "الموردين" },
                new Permission { Name = "suppliertypes.edit", DisplayName = "تعديل نوع مورد", Category = "الموردين" },
