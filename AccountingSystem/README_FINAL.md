...
### 9. سير العمل والاعتمادات
- **الموافقة الخطية (Linear)**: يظهر السند لجميع المستخدمين الذين يملكون حد اعتماد يساوي أو يفوق مبلغ السند، ويمكن لأي واحد منهم اعتماده مباشرة.
- **الموافقة الهرمية (Hierarchy)**: يتم ترتيب المستخدمين في مستويات اعتماد؛ فيظهر السند أولاً لأدنى مستوى يسمح بالمبلغ، وبعد اعتماده ينتقل تلقائياً للمستوى الأعلى حتى يصل لأعلى مستوى مطلوب ويصبح معتمداً نهائياً.
