...
namespace AccountingSystem.Services
{
    public interface INotificationService
    {
        ...
        Task<int> GetUnreadWorkflowCountAsync(string userId, CancellationToken cancellationToken = default);
        Task<int> GetUnreadLoginCountAsync(string userId, CancellationToken cancellationToken = default);
