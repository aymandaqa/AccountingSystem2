...
{
    public class WorkflowApprovalViewModelFactory : IWorkflowApprovalViewModelFactory
    {
        ...
        public WorkflowApprovalViewModelFactory(
        ...
        public async Task<IReadOnlyList<WorkflowApprovalViewModel>> BuildPendingApprovalsAsync(string userId, CancellationToken cancellationToken = default)
        {
